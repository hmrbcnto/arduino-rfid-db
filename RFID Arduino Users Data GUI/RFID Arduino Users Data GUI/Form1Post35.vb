...
Public Class Form1
    ...
    Dim Connection As New MySqlConnection("server=localhost; user=root; password=JeCEVd7Vwg3z!; database=rfid_user_data")
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT Name, ID, Address, City, Balance FROM " & Table_Name & " ORDER BY Name"
    ...
    Private Sub ShowDataUser()
        ...
        Try
            ...
            If Data > 0 Then
                ...
                LabelBalance.Text = DT.Rows(0).Item("Balance")
            Else
    ...
    Private Sub ClearInputUpdateData()
        ...
        TextBoxCity.Text = ""
        TextBoxBalance.Text = ""
        PictureBoxImageInput.Image = My.Resources.iconfinder_user_half_edit_103775
    ...
    Private Sub ButtonConnect_Click(sender As Object, e As EventArgs) Handles ButtonConnect.Click
        If ButtonConnect.Text = "Connect" Then
            ...
            Try
                ...
                PictureBoxStatusConnect.Image = My.Resources.images__2_

            Catch ex As Exception
                MsgBox("Failed to connect !!!" & vbCr & "Arduino is not detected.", MsgBoxStyle.Critical, "Error Message")
                PictureBoxStatusConnect.Image = My.Resources.images__1_
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If TextBoxBalance.Text = "" Then
            MessageBox.Show("Balance cannot be empty !!!", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        If StatusInput = "Save" Then
            ...
            Try
                ...
                With MySQLCMD
                    .CommandText = "INSERT INTO " & Table_Name & " (Name, ID, Address, City, Balance, Images) VALUES (@name, @ID, @address, @city, @balance, @images)"
                    ...
                    .Parameters.AddWithValue("@balance", TextBoxBalance.Text)
        ...
        Else
            ...
            If IMG_FileNameInput <> "" Then
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  Name=@name,ID=@id,Address=@address,City=@city,Balance=@balance,Images=@images WHERE ID=@id "
                        .Connection = Connection
                        .Parameters.AddWithValue("@name", TextBoxName.Text)
                        .Parameters.AddWithValue("@id", LabelGetID.Text)
                        .Parameters.AddWithValue("@address", TextBoxAddress.Text)
            ...
            Else
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  Name=@name,ID=@id,Address=@address,City=@city,Balance=@balance WHERE ID=@id "
                        .Connection = Connection
                        .Parameters.AddWithValue("@name", TextBoxName.Text)
                        .Parameters.AddWithValue("@id", LabelGetID.Text)
                        .Parameters.AddWithValue("@address", TextBoxAddress.Text)
    ...
    Private Sub TextBoxSearch_TextChanged(sender As Object, e As EventArgs) Handles TextBoxSearch.TextChanged
        If CheckBoxByID.Checked = True Then
            If TextBoxSearch.Text = Nothing Then
                SqlCmdSearchstr = "SELECT Name, ID, Address, City, Balance FROM " & Table_Name & " ORDER BY Name"
            Else
                SqlCmdSearchstr = "SELECT Name, ID, Address, City, Balance FROM " & Table_Name & " WHERE ID LIKE'" & TextBoxSearch.Text & "%'"
            End If
        End If
        If CheckBoxByName.Checked = True Then
            If TextBoxSearch.Text = Nothing Then
                SqlCmdSearchstr = "SELECT Name, ID, Address, City, Balance FROM " & Table_Name & " ORDER BY Name"
            Else
                SqlCmdSearchstr = "SELECT Name, ID, Address, City, Balance FROM " & Table_Name & " WHERE Name LIKE'" & TextBoxSearch.Text & "%'"
            End If
        End If
    ...
    Private Sub ClearSectionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ClearSectionToolStripMenuItem.Click
        DataGridView1.ClearSelection()
        PictureBoxImagePreview.Image = Nothing
    End Sub
        ...
        Try
            ...
            If Data > 0 Then
                ...
                Else
                    ...
                    TextBoxBalance.Text = DT.Rows(0).Item("Balance")
                    StatusInput = "Update"
                End If
            End If
        Catch ex As Exception
